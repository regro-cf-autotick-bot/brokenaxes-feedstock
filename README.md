...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/brokenaxes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11542&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/brokenaxes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `brokenaxes` can be installed with:

```
conda install brokenaxes
```

It is possible to list all of the versions of `brokenaxes` available on your platform with:
